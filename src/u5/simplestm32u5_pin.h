...
#include "simplestm32u5_device.h"
...
/**
 * @brief GPIO clock-enable adapter for STM32U5.
 *
 * Enables/disables the port's peripheral clock via RCC->AHB2ENR1 on
...
public:
    /**
     * @param pinmask RCC_AHB2ENR1_GPIOxEN bit for the target port.
