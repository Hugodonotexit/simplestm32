...
#include "simplestm32f0_device.h"

// Compiles to nothing when the whole simplestm32/src tree is added
// wholesale to a build targeting a different STM32 family.
#if defined(SIMPLESTM32_F0)

#include "../../vendor/cmsis_device_f0/Include/stm32f0xx.h"
#include "../base.h"

/**
 * @brief GPIO clock-enable adapter for STM32F0.
 *
