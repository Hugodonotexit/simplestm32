...
#include "simplestm32h5_device.h"

// Compiles to nothing when the whole simplestm32/src tree is added
// wholesale to a build targeting a different STM32 family.
#if defined(SIMPLESTM32_H5)

#include "../../vendor/cmsis_device_h5/Include/stm32h5xx.h"
#include "../base.h"

/**
 * @brief GPIO clock-enable adapter for STM32H5.
 *
 * Enables/disables the port's peripheral clock via RCC->AHB2ENR on
...
public:
    /**
     * @param pinmask RCC_AHB2ENR_GPIOxEN bit for the target port.
