...
#include "simplestm32wb_device.h"

// Compiles to nothing when the whole simplestm32/src tree is added
// wholesale to a build targeting a different STM32 family.
#if defined(SIMPLESTM32_WB)

#include "../../vendor/cmsis_device_wb/Include/stm32wbxx.h"
#include "../base.h"

/**
 * @brief GPIO clock-enable adapter for STM32WB.
 *
