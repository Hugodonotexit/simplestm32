...
#include "simplestm32f2_device.h"

// Compiles to nothing when the whole simplestm32/src tree is added
// wholesale to a build targeting a different STM32 family.
#if defined(SIMPLESTM32_F2)

#include "../../vendor/cmsis_device_f2/Include/stm32f2xx.h"
#include "../base.h"

/**
 * @brief GPIO clock-enable adapter for STM32F2.
 *
 * Enables/disables the port's peripheral clock via RCC->AHB1ENR on
...
public:
    /**
     * @param pinmask RCC_AHB1ENR_GPIOxEN bit for the target port.
