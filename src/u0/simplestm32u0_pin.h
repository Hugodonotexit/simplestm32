...
#include "simplestm32u0_device.h"

// Compiles to nothing when the whole simplestm32/src tree is added
// wholesale to a build targeting a different STM32 family.
#if defined(SIMPLESTM32_U0)

#include "../../vendor/cmsis_device_u0/Include/stm32u0xx.h"
#include "../base.h"

/**
 * @brief GPIO clock-enable adapter for STM32U0.
 *
 * Enables/disables the port's peripheral clock via RCC->IOPENR on
...
public:
    /**
     * @param pinmask RCC_IOPENR_GPIOxEN bit for the target port.
