...
#include "simplestm32g4_device.h"

// Compiles to nothing when the whole simplestm32/src tree is added
// wholesale to a build targeting a different STM32 family.
#if defined(SIMPLESTM32_G4)

#include "../../vendor/cmsis_device_g4/Include/stm32g4xx.h"
#include "../base.h"

/**
 * @brief GPIO clock-enable adapter for STM32G4.
 *
