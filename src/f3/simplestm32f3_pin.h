...
#include "simplestm32f3_device.h"

// Compiles to nothing when the whole simplestm32/src tree is added
// wholesale to a build targeting a different STM32 family.
#if defined(SIMPLESTM32_F3)

#include "../../vendor/cmsis_device_f3/Include/stm32f3xx.h"
#include "../base.h"

/**
 * @brief GPIO clock-enable adapter for STM32F3.
 *
 * Enables/disables the port's peripheral clock via RCC->AHBENR on
...
public:
    /**
     * @param pinmask RCC_AHBENR_GPIOxEN bit for the target port.
