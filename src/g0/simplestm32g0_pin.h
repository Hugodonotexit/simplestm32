...
#include "simplestm32g0_device.h"

// Compiles to nothing when the whole simplestm32/src tree is added
// wholesale to a build targeting a different STM32 family.
#if defined(SIMPLESTM32_G0)

#include "../../vendor/cmsis_device_g0/Include/stm32g0xx.h"
#include "../base.h"

/**
 * @brief GPIO clock-enable adapter for STM32G0.
 *
