...
#include "simplestm32l5_device.h"

// Compiles to nothing when the whole simplestm32/src tree is added
// wholesale to a build targeting a different STM32 family.
#if defined(SIMPLESTM32_L5)

#include "../../vendor/cmsis_device_l5/Include/stm32l5xx.h"
#include "../base.h"

/**
 * @brief GPIO clock-enable adapter for STM32L5.
 *
