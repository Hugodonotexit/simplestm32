...
#include "simplestm32wl_device.h"

// Compiles to nothing when the whole simplestm32/src tree is added
// wholesale to a build targeting a different STM32 family.
#if defined(SIMPLESTM32_WL)

#include "../../vendor/cmsis_device_wl/Include/stm32wlxx.h"
#include "../base.h"

/**
 * @brief GPIO clock-enable adapter for STM32WL.
 *
